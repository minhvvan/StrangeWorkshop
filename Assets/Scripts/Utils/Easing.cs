...
public static class Easing
{
    ...
    public static EasingFunction GetEasingFunction(EaseType easeType)
    {
        switch (easeType)
        {
            ...
            /* GFX47 MOD START */
            /*case EaseType.bounce: return new EasingFunction(bounce);*/
            ...
            /* GFX47 MOD START */
            /*case EaseType.elastic: return new EasingFunction(elastic);*/
            ...
            case EaseType.punch: return new EasingFunction(punch);
                /* GFX47 MOD END */
        }
        return null;
    }
    ...
    public static float punch(float start, float amplitude, float value)
    {
        ...
        return start + (amplitude * Mathf.Pow(2, -10 * value) * Mathf.Sin((value * 1 - s) * (2 * Mathf.PI) / period));
    }
